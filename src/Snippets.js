...
const Snippets = {
  tags: function ({ id, events, dataLayer, dataLayerName, preview, auth, customURL }) {
    ...
    const script = `
      (function(w,d,s,l,i){w[l]=w[l]||[];
        ...
        j.async=true;j.src='${customURL || baseURL}?id='+i+dl+'${gtm_auth}${gtm_preview}&gtm_cookies_win=x';
